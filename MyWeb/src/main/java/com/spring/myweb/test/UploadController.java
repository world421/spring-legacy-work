...
public class UploadController {
	...
	public void upload(MultipartFile file) { //void니까/upload_ok 이경로로감 
        ...
        */
		...
		if(!f.exists()) { // exists 존재여부 없니? false라고 물어보는거 
	...
	public String upload2(MultipartHttpServletRequest files) {//jsp 파일 파라미터 변수명 동일하게 작성
