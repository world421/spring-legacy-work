...
<%@ include file="../include/footer.jsp" %>
    ...
    <script>
        ...
        document.getElementById('idCheckBtn').onclick = function() {
            ...
            */
            ...
            .then(res =>{ //res는 변수명 
                ...
                console.log(res);
                console.log('서버가 전달한 데이터: ', res.text()); //서버가 전달한 값이 text면 
        ...
        //인증번호 이메일 전송 
        document.getElementById('mailCheckBtn').onclick = function(){
            ...
            .then(data => {
                ...
                code = data; //서버가 전달한 인증번호를 전역번수에 저장.
        ...
        document.querySelector('.mail-check-input').onblur = function(e){
          ...
          if(inputCode === code){
            ...
            // 초기값 저장해놨다가 change 발생하면 초기값으로 바꾸는거임! !!
        ...
        //다음 주소 API 사용해보기 (script src 추가 해야합니다.)

    function searchAddress() {
        new daum.Postcode({
            oncomplete: function(data) { // 사용자가 선택한 항목이 data로 들어옴! 
        ...
        document.getElementById('joinBtn').onclick = function(){
            if(idFlag && pwFlag ){
                ...
                if(!document.getElementById('mailCheckBtn').disabled){
        ...
        id.onkeyup = function() { // onkeyup 사용자가 키보드를 눌렀다가 뗏을 때 발생하는 
            /*
                자바스크립트의 정규표현식 입니다
        ...
        pw.onkeyup = function(){
            var regex = /^[A-Za-z0-9+]{8,16}$/;
             if(regex.test(document.getElementById("userPw").value )) {
                ...
                document.getElementById("msgPw").innerHTML = "비밀번호를 올바르게 입력하세요!";
                pwFlag = false;
            }
        }
        /*비밀번호 확인검사*/
