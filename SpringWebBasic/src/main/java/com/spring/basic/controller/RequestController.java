...
public class RequestController {
	...
	public void register() {
		...
		// return "request/join"; void : request/join
	}
	
	//요청 URL주소가 같더라도 , 전송방식에 따라 맵핑을 다르게 하기 때문에
	...
	*/
	...
	@PostMapping("/join")
	public void register(
			String userId, // () 파라미터 name 쓰기 파라미터 값을 받아줄 변수 선언!
			String userPw,
			@RequestParam(value="hobby", required = false, defaultValue = "no hobby person") List<String> hobby // 리스트에 담아서 알아서 가져다줌 , 
			//requestParam 값 전달 무조건 전제하에 
	) {
